...
├── reference_tables/                  # optional public reference CSV files
├── notebooks/
│   ├── 01_ETL_covid_serie_historica.ipynb
│   ├── 02_ETL_arboviroses.ipynb
│   ├── 03_ETL_escorpiao_serie_historica.ipynb
│   ├── 04_ETL_dengue_espacial.ipynb
│   ├── 05_ETL_chikungunya_espacial.ipynb
│   ├── 06_ETL_dimensoes.ipynb
...
└── sql/                              # optional exported SQL views
```

## Suggested `.gitignore`

```gitignore
# Databricks and local configuration
.env
*.token
*.pem
*.key
